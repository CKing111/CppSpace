...
int main() {
    ...
    std::vector<std::string> filenames = {
        "公共课成绩.csv", "理科成绩.csv", "文科成绩.csv"}; // 要读取的CSV文件名
    ...
    for (const auto& filename : filenames) { // 遍历动态数组
        ...
        while (std::getline(
            file,
            line)) { 
            // 从file中逐行读取数据，并将每行的内容存储在字符串变量line中，while遍历整个文件
            // 解析CSV文件中的每一行数据
            CSVData csvEntry;
            ...
            while (
                ...
                token = line.substr(
                    0,
                    pos); // 提取逗号之前的子字符串,起始索引位置和要提取的子串长度。
...
/*
Column 1: 学生A, Column 2: 文科, Column 3: 80.5
Column 1: 学生B, Column 2: 理科, Column 3: 85.3
Column 1: 学生C, Column 2: 文科, Column 3: 75.9
Column 1: 学生D, Column 2: 理科, Column 3: 80
Column 1: 学生E, Column 2: 文科, Column 3: 78
Column 1: 学生F, Column 2: 理科, Column 3: 88.9
Column 1: 学生G, Column 2: 文科, Column 3: 93.2
Column 1: 学生H, Column 2: 理科, Column 3: 76.5
